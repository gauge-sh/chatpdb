...
from chatpdb.debugger import ChatPdb, TerminalChatPdb
...
_usage = (
    """\
usage: python -m chatpdb [-m] [-c command] ... pyfile [arg] ...
...
chatpdb is using ipdb version %s."""
    % __version__
)
